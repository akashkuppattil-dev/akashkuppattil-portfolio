...
export default function WhatsAppWidget() {
    ...
    const handleChat = (type: "hire" | "project" | "connect") => {
        const messages = {
            hire: "Hi Akash! I'm interested in hiring you for a full-stack role.",
            project: "Hi Akash! I have a high-performance project idea for Lumora Triad.",
            connect: "Hi Akash! I've been exploring your architectural portfolio."
        }
                ...
                {open && (
                    ...
                    >
                        ...
                        <div className="p-8 flex flex-col gap-6">
                            <p className="text-muted-foreground text-[10px] font-black uppercase tracking-[0.3em] leading-relaxed">
                                Professional Inquiries <br/> & Project Design.
                            </p>
                ...
                <AnimatePresence>
                    {showBadge && (
                        <motion.span
                            ...
                            animate={{ scale: 1 }}
                            exit={{ scale: 0 }}
                            className="absolute -top-1 -right-1 w-5 h-5 bg-red-600 rounded-full text-white text-[9px] font-black flex items-center justify-center shadow-lg border-2 border-background"
                        >
                            1
                        </motion.span>
                    )}
